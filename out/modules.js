...
function table$mod(w = 80, d = 50, h = 40, top_t = 3) {
  ...
  return Manifold.union([
    ...
    Manifold.union(__flat_map_iter([0, __sub(w, 6)], (x) => [Manifold.union(__flat_map_iter([0, __sub(d, 6)], (y) => [__with_children(() => Manifold.union([]), 0, () => leg$mod(/* h = */ h)).translate([__add(x, 3), __add(y, 3), 0])]))]))
  ]);
}
...
export const result = __with_children(() => Manifold.union([]), 0, () => table$mod());