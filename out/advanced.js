...
export const result = ((__s) => Manifold.cube((is_list_fn(__s) ? __s : [__s, __s, __s]), true))([size, size, size]).subtract(Manifold.cylinder(__add(size, 1), hole_r, hole_r, 64, true));